      ...
      <div className='about__content text-center  '>
        ...
        <div className=' grid
         ...
         <div className='div-1 bronzy rounded drop-shadow-lg md:col-span-2 md:rows-span-2  p-[3%] card'>
          ...
          <p className='mt-[4%] xs:text-md sm:text-lg 3xl:text-5xl xl:text-2xl font-primerg' >An initiative by IIIT Pune to educate the school students about business culture.</p>
         </div>
        
         <div className='div-3  platy  md:row-span-2 md:col-span-3 p-[3%]  backdrop-blur-lg rounded drop-shadow-lg card '>
         <h1  className='font-andromeda xs:text-2xl sm:text-3xl lg:text-4xl xl:text-6xl 3xl:text-8xl  tracking-wider'>Heading</h1>
         ...
         <h1  className='font-andromeda xs:text-2xl sm:text-3xl lg:text-4xl xl:text-6xl 3xl:text-8xl md:pb-7 tracking-wider'>Core Values</h1>
