    ...
    <div className='about' id="about">
      <div className='about__content text-center  '>
        ...
        <div className=' grid
         ...
         <h1 className='font-andromeda xs:text-2xl sm:text-3xl lg:text-4xl xl:text-6xl 3xl:text-8xl' >VISION </h1>
          <p className='mt-[3%] xs:text-md sm:text-lg lg:text-xl xl:text-xl 3xl:text-5xl font-primerg'>An opportunity for the students to interact with college students which will give the aspiring students a clarity in vision.</p>
         </div>
         <div className='div-1 bronzy rounded drop-shadow-lg md:col-span-2 md:rows-span-2  p-[3%] card'>
          <h1 className='font-andromeda xs:text-2xl sm:text-3xl lg:text-4xl xl:text-6xl 3xl:text-8xl mt-[2%]' >MISSION </h1>
          <p className='mt-[4%] xs:text-md sm:text-lg 3xl:text-5xl xl:text-xl font-primerg' >An initiative by IIIT Pune to educate the school students about business culture.</p>
         </div>
        
         <div className='div-3  platy  md:row-span-2 md:col-span-3 p-[3%]  backdrop-blur-lg rounded drop-shadow-lg card '>
         <h1  className='font-andromeda xs:text-2xl sm:text-3xl lg:text-4xl xl:text-6xl 3xl:text-8xl '>Heading</h1>
         <p className='p-[3%] mt-[3%] xs:text-md sm:text-lg 3xl:text-5xl xl:text-xl font-primerg'>
          ...
          <p className='p-[3%]  xs:text-md sm:text-lg 3xl:text-5xl xl:text-xl font-primerg'>
         ...
         <h1  className='font-andromeda xs:text-2xl sm:text-3xl lg:text-4xl xl:text-6xl 3xl:text-8xl md:pb-7'>Core Values</h1>
         ...
         <h1 className='font-andromeda xs:text-2xl sm:text-3xl lg:text-4xl xl:text-6xl 3xl:text-8xl '>PRIZES </h1>
          <p className='p-[3%] xs:text-md sm:text-lg xl:text-xl 3xl:text-5xl font-primerg'>
