...
export const data = [
  {
    id: 1,
    question: "What is E-Summit'23 Junior?",
    answer:
  ...
  },
  {
    ...
    answer:
      "In the first round, we will pick the top performers from all the participants. In the second round, we will invite them to the Campus of the Indian Institute of Information Technology, Pune, for an offline competition. ",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answer:
      "They can get the golden opportunity to visit an Institute of National Importance at such a young age. They will be able to meet and interact with some of the most esteemed speakers in the industry and emerging entrepreneurs from various Institutes of National Importance.",
  },
  {
    id: 7,
    question: "Who can participate in the event?",
    answer: "Anyone studying class VIII, IX or Xth is eligible to participate.",
  },
  {
    id: 8,
